...
<body>
    <div class="container">
        ...
        <?php
            // $_GET['nameOfInputan'] => mengambil name dari inputan dengan method GET (sesuai method yg ada pada form)
            ...
            if(isset($_GET['submit'])){
                ...
                $email = $_GET['email'];
                $password = sha1($_GET['password']); // sha1 => salah satu methode enkripsi
        ...
        ?>
            ...
            <table class="table table-bordered"> <!-- table => tabel -->
                <tr> <!-- tr => row / baris -->
